...
(define TestingController%
  (class* object% (Controller<%>)
    ...
    (define (after-drag-inside-controller) 5)
    ...
    (define (viewer-image) empty-scene)
    ...
    (define/public (for-test:controller-selected?)
      controller-selected?)
    (define/public (for-test:handler-selected?)
      handler-selected?)
    (define/public (for-test:x) x)
    (define/public (for-test:y) y)
    (define/public (for-test:particle-x) particle-x)
    (define/public (for-test:particle-y) particle-y)
    (define/public (for-test:particle-vx) particle-vx)
    (define/public (for-test:particle-vy) particle-vy)
    ))
