...
;; A WorldState% is a (new WorldState% [canvas-width NonNegInt] 
;;                                     [canvas-height NonNegInt]
;; optional, defaults to empty         [objs ListOfWidget<%>]
;; optional, defaults to empty         [sobjs ListOfSWidget<%>])
