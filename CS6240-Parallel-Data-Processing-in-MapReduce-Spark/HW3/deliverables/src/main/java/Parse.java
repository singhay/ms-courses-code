    ...
    public static class Map extends Mapper<Object, Text, Text, Text> {
        ...
        public void map(Object key, Text value, Context context
            ...
            if (!skip) {
                ...
                output.append("\t").append("initPageRank");
    ...
    public static class Reduce extends Reducer<Text, Text, Text, NullWritable> {
        ...
        public void reduce(Text key, Iterable<Text> values, Context context)
            ...
            for (Text value : values) {
                if (!value.toString().equals("maybeDangling"))
            ...
            if (maybeDangling == valuesLen)
                context.write(new Text(key.toString() + "\t" + "initPageRank"), NullWritable.get());
    ...
    public static long parse(String[] args) throws Exception {
        ...
        if (otherArgs.length != 2) {
            if (!args[0].endsWith(".bz2"))
                ...
                System.err.println("Usage: WikiMRParser <in> <out>");
            System.exit(1);
        }
